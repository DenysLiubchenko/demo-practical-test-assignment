...
import io.clearsolutions.demo.exception.handler.CustomExceptionHandler;
...
class UserControllerTest {
    ...
    @Test
    void updateAllUserFieldsTest() throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.registerModule(new JavaTimeModule());

        when(userService.updateAllUserFields(userRequestDto, 1L)).thenReturn(userResponseDto);
        ...
        verify(userService).updateAllUserFields(userRequestDto, 1L);
    }
    ...
    void createUserTest() throws Exception {
        ...
        when(userService.processUser(userRequestDto)).thenReturn(userResponseDto);
        ...
        verify(userService).processUser(userRequestDto);
    }

    @Test
    void updateSomeUserFieldsTest() throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        objectMapper.registerModule(new JavaTimeModule());
        ...
        when(userService.updateSomeUserFields(argThat(argumentMatcher), eq(1L))).thenReturn(userResponseDto);
        ...
        verify(userService).updateSomeUserFields(argThat(argumentMatcher), eq(1L));
    }
}
